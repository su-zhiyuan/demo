...
public class Evection {
    ...
    public void setJtgj(String jtgj) {
        this.jtgj = jtgj == null ? null : jtgj.trim();
    }
    ...
    public void setCitycf(String citycf) {
        this.citycf = citycf == null ? null : citycf.trim();
    }
    ...
    public void setCitydd(String citydd) {
        this.citydd = citydd == null ? null : citydd.trim();
    }
    ...
    public void setTxr(String txr) {
        this.txr = txr == null ? null : txr.trim();
    }
