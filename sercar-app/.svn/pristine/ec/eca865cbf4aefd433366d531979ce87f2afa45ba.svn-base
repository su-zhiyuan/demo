...
public class Dispatching {
    ...
    private List<Dsmx> dsmxs;
    
    private List<String> paridList;
    
    public List<String> getParidList() {
		return paridList;
	}

	public void setParidList(List<String> paridList) {
		this.paridList = paridList;
	}

	public List<Dsmx> getDsmxs() {
		return dsmxs;
	}

	public void setDsmxs(List<Dsmx> dsmxs) {
		this.dsmxs = dsmxs;
	}
    ...
    public void setDispatchingId(String dispatchingId) {
        this.dispatchingId = dispatchingId == null ? null : dispatchingId.trim();
    }
    ...
    public String getCehckedTime() {
        return cehckedTime;
    }

    public void setCehckedTime(String cehckedTime) {
        this.cehckedTime = cehckedTime == null ? null : cehckedTime.trim();
    }
    ...
    public void setMaintenanceTechnician(String maintenanceTechnician) {
        this.maintenanceTechnician = maintenanceTechnician == null ? null : maintenanceTechnician.trim();
    }
    ...
    public void setExpectedCompletionDate(String expectedCompletionDate) {
        this.expectedCompletionDate = expectedCompletionDate == null ? null : expectedCompletionDate.trim();
    }
