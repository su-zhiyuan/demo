...
public class PartOffer {
	...
	public List<Pomx> getPomxs() {
		return pomxs;
	}

	public void setPomxs(List<Pomx> pomxs) {
		this.pomxs = pomxs;
	}
    ...
    public void setOfferBy(String offerBy) {
        this.offerBy = offerBy == null ? null : offerBy.trim();
    }
    ...
    public void setSaleBy(String saleBy) {
        this.saleBy = saleBy == null ? null : saleBy.trim();
    }
