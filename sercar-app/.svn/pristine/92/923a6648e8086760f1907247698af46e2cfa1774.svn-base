...
public class Messlist {
    ...
    public void setMlistId(String mlistId) {
        this.mlistId = mlistId == null ? null : mlistId.trim();
    }
    ...
    public void setRecby(String recby) {
        this.recby = recby == null ? null : recby.trim();
    }
    ...
    public void setUnreadcount(String unreadcount) {
        this.unreadcount = unreadcount == null ? null : unreadcount.trim();
    }
    ...
    public void setEndmess(String endmess) {
        this.endmess = endmess == null ? null : endmess.trim();
    }
}