...
public class GoodsRC {
    private String goodsrcId;

    private String caigourcId;
    ...
    private List<String> cgphotos;
    
    public List<String> getCgphotos() {
		return cgphotos;
	}

	public void setCgphotos(List<String> cgphotos) {
		this.cgphotos = cgphotos;
	}
	...
	public String getGoodsrcId() {
        return goodsrcId;
    }

    public void setGoodsrcId(String goodsrcId) {
        this.goodsrcId = goodsrcId == null ? null : goodsrcId.trim();
    }

    public String getCaigourcId() {
        return caigourcId;
    }

    public void setCaigourcId(String caigourcId) {
        this.caigourcId = caigourcId == null ? null : caigourcId.trim();
    }
    ...
    public String getCreacteTime() {
        return creacteTime;
    }

    public void setCreacteTime(String creacteTime) {
        this.creacteTime = creacteTime == null ? null : creacteTime.trim();
    }
