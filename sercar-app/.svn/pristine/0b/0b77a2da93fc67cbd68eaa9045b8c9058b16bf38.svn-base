...
public class Cardclock {
    ...
    public String getCardclockId() {
        return cardclockId;
    }

    public void setCardclockId(String cardclockId) {
        this.cardclockId = cardclockId == null ? null : cardclockId.trim();
    }
    ...
    public void setUpplace(String upplace) {
        this.upplace = upplace == null ? null : upplace.trim();
    }
    ...
    public void setDownplace(String downplace) {
        this.downplace = downplace == null ? null : downplace.trim();
    }
