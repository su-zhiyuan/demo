...
public class Resumeexperience {
    private String resumeexperienceId;
    ...
    public String getResumeexperienceId() {
        return resumeexperienceId;
    }

    public void setResumeexperienceId(String resumeexperienceId) {
        this.resumeexperienceId = resumeexperienceId == null ? null : resumeexperienceId.trim();
    }
