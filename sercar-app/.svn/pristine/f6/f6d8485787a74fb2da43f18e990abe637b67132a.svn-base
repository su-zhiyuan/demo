...
public class Applyjb {
    private String applyjbId;
    ...
    public String getApplyjbId() {
        return applyjbId;
    }

    public void setApplyjbId(String applyjbId) {
        this.applyjbId = applyjbId == null ? null : applyjbId.trim();
    }
