...
public class Resume {
    ...
    public String getZhenzhimianmao() {
        return zhenzhimianmao;
    }

    public void setZhenzhimianmao(String zhenzhimianmao) {
        this.zhenzhimianmao = zhenzhimianmao == null ? null : zhenzhimianmao.trim();
    }
    ...
    public void setZiwopingjia(String ziwopingjia) {
        this.ziwopingjia = ziwopingjia == null ? null : ziwopingjia.trim();
    }
