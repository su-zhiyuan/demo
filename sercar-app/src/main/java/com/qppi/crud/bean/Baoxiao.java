...
public class Baoxiao {
    ...
    private List<String> cwphotos;
    
    private List<String> bxphotos;
	...
	public List<String> getBxphotos() {
		return bxphotos;
	}

	public void setBxphotos(List<String> bxphotos) {
		this.bxphotos = bxphotos;
	}

	public List<String> getCwphotos() {
		return cwphotos;
	}

	public void setCwphotos(List<String> cwphotos) {
		this.cwphotos = cwphotos;
	}
    ...
    public void setBaoxiaoId(String baoxiaoId) {
        this.baoxiaoId = baoxiaoId == null ? null : baoxiaoId.trim();
    }
