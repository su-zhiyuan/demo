...
public class CarInfo {
    ...
    public void setCarBrank(String carBrank) {
        this.carBrank = carBrank == null ? null : carBrank.trim();
    }

    public String getCarXl() {
        return carXl;
    }

    public void setCarXl(String carXl) {
        this.carXl = carXl == null ? null : carXl.trim();
    }
    ...
    public void setColorOut(String colorOut) {
        this.colorOut = colorOut == null ? null : colorOut.trim();
    }
    ...
    public void setColorIn(String colorIn) {
        this.colorIn = colorIn == null ? null : colorIn.trim();
    }
