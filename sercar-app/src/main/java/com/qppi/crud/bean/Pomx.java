...
public class Pomx {
    private String pomxId;

    private String partOfferId;
    ...
    public void setPomxId(String pomxId) {
        this.pomxId = pomxId == null ? null : pomxId.trim();
    }
    ...
    public void setPartOfferId(String partOfferId) {
        this.partOfferId = partOfferId == null ? null : partOfferId.trim();
    }
    ...
    public void setSettId(String settId) {
        this.settId = settId == null ? null : settId.trim();
    }
    ...
    public void setPartCount(String partCount) {
        this.partCount = partCount == null ? null : partCount.trim();
    }
    ...
    public void setPurCount(String purCount) {
        this.purCount = purCount == null ? null : purCount.trim();
    }
