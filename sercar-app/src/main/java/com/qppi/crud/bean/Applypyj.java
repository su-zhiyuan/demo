...
public class Applypyj {
    private String applypyjId;
	...
	public String getApplypyjId() {
        return applypyjId;
    }

    public void setApplypyjId(String applypyjId) {
        this.applypyjId = applypyjId == null ? null : applypyjId.trim();
    }
