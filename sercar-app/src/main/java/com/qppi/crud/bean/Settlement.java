...
public class Settlement {
    ...
    private List<String> disName;
    
    private List<String> disType;
    
    public List<String> getDisName() {
		return disName;
	}

	public void setDisName(List<String> disName) {
	...
	public void setDisType(List<String> disType) {
    ...
    private List<PartOffer> pos;

	public List<PartOffer> getPos() {
		return pos;
	}

	public void setPos(List<PartOffer> pos) {
		this.pos = pos;
	}
