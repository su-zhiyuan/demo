package com.fh.service.sercar.leave.impl;
...
public class LeaveService implements LeaveManager{
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("LeaveMapper.delete", pd);
	}
	...
	@Override
	public List<PageData> tongji(Page pd) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>) dao.findForList("LeaveMapper.tongji", pd);
	}
