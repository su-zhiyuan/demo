				...
				<div class="page-content">
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<tr>
								<td class="center">消费基盘数新增： ${carInfoSize }</td>
							</tr>
						</table>
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<tr>
								...
								<td class="center"> 基盘客户数量： ${jpkh }</td>
								<td class="center"> 消费基盘数： ${xfjp }</td>
							</tr>
						</table>
										...
										<tr>
											...
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-mini btn-success" style="margin-right:3px; height:30px;line-height:30px; margin-bottom:5px;" onclick="getDetails('${var.ORDER_ID}');">详情</a>
												</div>
											</td>
										</tr>
