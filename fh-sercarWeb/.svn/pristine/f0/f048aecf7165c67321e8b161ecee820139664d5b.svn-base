								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.MINGZU}</td>
											<td class='center'>${var.ZHENZHIMIANMAO}</td>
											<td class='center'>${var.HUJI}</td>
											...
											<td class='center'>${var.XUELI}</td>
											<td class='center'>${var.ZHUANYE}</td>
											<td class='center'>${var.SCHOOL}</td>
											<td class='center'><img src="${var.PHOTO}" style="height: 50px"></td>
											<td class='center'>${var.YL2}</td>
											<td class='center'>${var.ZIWOPINGJIA}</td>
