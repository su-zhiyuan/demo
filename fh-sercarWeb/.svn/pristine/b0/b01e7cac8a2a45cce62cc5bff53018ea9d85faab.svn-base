...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center" style="width:100px;">担保人</th>
									<th class="center" style="width:100px;">担保人电话</th>
								...
								<c:when test="${not empty list}">
									<c:forEach items="${list }" var="var" varStatus="vs">
										<tr>
											...
											<c:if test="${not empty var.settle}">
												<td class='center'>${var.settle.TOTAL}</td>
											</c:if>
											<c:if test="${empty var.settle}">
											...
											<td>
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${var.STATUS == '待担保人确认' }">
														<a class="btn btn-mini btn-success" style="margin-right:2px; height:30px;line-height:30px; margin-bottom:5px;" onclick="agreedanbao('${var.ORDER_ID}');">同意担保</a>
														<a class="btn btn-mini btn-success" style="margin-right:2px; height:30px;line-height:30px; margin-bottom:5px;" onclick="disagreedanbao('${var.ORDER_ID}');">不同意担保</a>
													</c:if>
												</div>
	...
	<script type="text/javascript">
		...
		function agreedanbao(Id){
			$.ajax({
				url: "<%=basePath%>danbao/agreeDanBao.do",
				data:{
					"ORDER_ID" : Id
				},
				type: "post",
		...
		//不同意担保
		function disagreedanbao(Id){
			$.ajax({
				url: "<%=basePath%>danbao/disagreeDanBao.do",
				data:{
					"ORDER_ID" : Id
				},
				type: "post",
