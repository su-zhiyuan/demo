		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="car/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
...
<%-- 											<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/policy/downExcel.do'">下载模版</a> --%>
										</td>
									</tr>
								</table>
								</div>
