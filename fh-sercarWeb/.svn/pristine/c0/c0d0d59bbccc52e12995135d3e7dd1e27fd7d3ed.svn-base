			...
			<div class="page-content">
				<div class="row">
					...
					<form action="recheck/save.do" name="Form" id="Form" method="post">
						<input type="hidden" name="PARTOFFER_ID" id="PARTOFFER_ID" value="${pd.PARTOFFER_ID}"/>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		//同意
		function agree(){
			var PARTOFFER_ID = $("#PARTOFFER_ID").val();
			var gongsiId = $("#gsid").val();
			var username = $("#username").val();
			var name = $("#name").val();
			var content = $("#content").val();
			$.ajax({
				url: "<%=basePath%>recheck/agreePartoffer.do",
				data: {
		...
		function disagree(){
			...
			var content = $("#content").val();
			$.ajax({
				url: "<%=basePath%>recheck/disagreePartoffer.do",
				data: {
					"PARTOFFER_ID": PARTOFFER_ID,
					"gongsiId": gongsiId,
					"username": username,
