									...
									<c:if test="${not empty varList }">
										<c:forEach items="${varList }" var="part">
											<c:if test="${not empty part.pomxList }">
												<c:forEach items="${part.pomxList }" var="pomx">
														<tr>
														...
														<tr>
															...
															<td><input type="text" name="PRICE" id="PRICE" value="${pomx.PRICE}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
														</tr>
														<tr>
														...
														<tr>
															<td style="width:75px;text-align: right;padding-top: 13px;">毛利:</td>
															<td><input type="text" name="ml" id="ml" value="${pomx.ml}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
														</tr>
														<tr>
															<td colspan="2"></td>
														</tr>
