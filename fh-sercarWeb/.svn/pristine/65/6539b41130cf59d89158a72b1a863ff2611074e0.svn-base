		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="reservations/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="RESERVATIONS_ID" id="RESERVATIONS_ID" value="${pd.RESERVATIONS_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="CONTACTSTEL" id="CONTACTSTEL" value="${pd.CONTACTSTEL}" maxlength="50" placeholder="联系电话" title="联系电话" style="width:98%;"/></td>
							</tr>		
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注:</td>
								<td><input type="text" name="REMARKS" id="REMARKS" value="${pd.REMARKS}" maxlength="500" placeholder="这里输入备注" title="备注" style="width:98%;"/></td>
							</tr>
							<c:if test="${msg == 'edit'}">
							<tr>
