					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastLoginStart" id="lastLoginStart"  value="${pd.lastLoginStart}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:85px;" placeholder="最近登录开始" title="最近登录开始"/></td>
								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastLoginEnd" name="lastLoginEnd"  value="${pd.lastLoginEnd}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:85px;" placeholder="最近登录结束" title="最近登录结束"/></td>
								...
								<c:when test="${not empty userList}">
									...
									<c:forEach items="${userList}" var="user" varStatus="vs">
										...
										<tr>
											...
											<td class='center'>
											<c:if test="${user.STATUS=='使用'}">使用</c:if>
											<c:if test="${user.STATUS=='停用'}">停用</c:if>
											</td>
											<td class="center">
