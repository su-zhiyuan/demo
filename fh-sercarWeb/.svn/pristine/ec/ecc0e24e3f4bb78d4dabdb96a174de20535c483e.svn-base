...
<body class="no-skin">
										...
										<tr>
											...
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${var.STATUS == '待确认' }">
														<a class="btn btn-mini btn-success" style="margin-right:3px; height:30px;line-height:30px; margin-bottom:5px;" onclick="affirm('${var.SETTLEMENT_ID}');">财务确认</a>
													</c:if>
												</div>
											</td>
										</tr>
	...
	<script type="text/javascript">
		...
		function affirm(Id){
			$.ajax({
				url: "<%=basePath%>settlement/affirmSettlement.do",
				data:{
					"SETTLEMENT_ID" : Id
				},
				type: "post",
