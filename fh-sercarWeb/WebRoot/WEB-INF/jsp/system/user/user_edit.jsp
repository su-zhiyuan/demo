						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
											...
											<td>
												<select  name="STATUS" id="STATUS">
													<option value="">请选择</option>
									  				<option value="使用" <c:if test="${pd.STATUS=='使用'}">selected</c:if>>使用</option>
									 				<option value="停用" <c:if test="${pd.STATUS=='停用'}">selected</c:if>>停用</option>
									 			</select>
											</td>
										</tr>
										<%-- <tr>
										...
										<%-- <tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">权限类型:</td>
											<td><select name="ROLETYPE" id="ROLETYPE" value="${pd.ROLETYPE}" maxlength="255" placeholder="这里输入权限类型" title="权限类型" style="width:98%;">
											...
											<tr>
												...
												<td>
													<select class="chosen-select form-control" name="BZ" id="BZ" data-placeholder="请选择所属公司" style="vertical-align:top;" style="width:98%;" >
														<option value=""></option>
															<c:forEach items="${companysList}" var="company">
																	<%-- <option value="${company.COMPANYINFO_ID }">${company.COMPANY_NAME }</option> --%>
																<option value="${company.COMPANYINFO_ID }" <c:if test="${company.COMPANYINFO_ID==pd.BZ}">selected</c:if> > ${company.COMPANY_NAME }</option>
															</c:forEach>
													</select>
												</td>
											</tr>
											...
											<tr style="display:none">
												<td style="width:79px;text-align: right;padding-top: 13px;">所属公司:</td>
												<td><input type="text" name="BZ" id="BZ"value="${pd.BZ }" placeholder="这里输入所属公司" maxlength="64" title="备注" style="width:98%;"/></td>
											</tr>
											</c:if>
										<tr>
