			...
			<div class="page-content">
				<div class="row">
					...
					<form action="order/save.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						<input type="hidden" name="RECEPTION_ID" id="RECEPTION_ID" value="${reception.RECEPTION_ID}"/>
						
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">车牌号:</td>
								<td><input type="text" name="CAR_NUM1" id="CAR_NUM1" value="${carInfo.CAR_NUM1}" maxlength="50" placeholder="这里输入车牌号" title="车牌号" style="width:98%;" /></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">车架号:</td>
								<td><input type="text" name="CAR_NUM2" id="CAR_NUM2" value="${carInfo.CAR_NUM2}" maxlength="50" placeholder="这里输入车架号" title="车架号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">发动机号:</td>
								<td><input type="text" name="CAR_NUM3" id="CAR_NUM3" value="${carInfo.CAR_NUM3}" maxlength="50" placeholder="这里输入发动机号" title="发动机号" style="width:98%;" /></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">汽车品牌:</td>
								<td style="vertical-align:top;padding-left:2px;">								
									<select name="YL20" id="YL20" onchange="getCheXi('${carInfo.YL1}')">
										<option value=""> --请选择--</option>
			                            <c:forEach items="${list}" var="var" varStatus="vs">
			                                <option value="${var}" <c:if test="${var == carInfo.CAR_BRANK}">selected</c:if> > ${var}</option>
			                            </c:forEach>
                        			</select>						
								</td>
							</tr>
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">								
									<select name="YL19" id="YL19" >
										<option value="${carInfo.YL1}" >${carInfo.YL1}</option>
                        			</select>						
								</td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="YL18" id="YL18" maxlength="50" value="${contacts.CONTACT}" placeholder="这里输入联系人" title="联系人" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">联系电话：</td>
								<td><input type="text" name="YL17" id="YL17" value="${contacts.CONTACT_TEL}" maxlength="50" placeholder="这里输入联系电话" title="联系电话" style="width:98%;"/></td>
							</tr>
							<tr>
									...
									<div class="upload-content">
										<div class="content-img">
											<ul class="content-img-list" id="youliang">
												<c:if test="${not empty reception.YL7}">
													<li class="content-img-list-item"><img src="${reception.YL7}" alt=""><a class="delete-btn" onclick="ylsc(this)"><i class="ico-delete"></i></a></li>												
												</c:if>
											</ul>
									...
									<div class="upload-content">
										<div class="content-img">
											...
											<ul class="content-img-list" id="licheng">
												<c:if test="${not empty reception.YL5}">
													<li class="content-img-list-item"><img src="${reception.YL5}" alt=""><a class="delete-btn" onclick="lcsc(this)"><i class="ico-delete"></i></a></li>												
												</c:if>
											</ul>
											...
											<ul class="content-img-list" id="waiguan">
												<c:if test="${not empty photo}">
													<c:forEach items="${photo}" var="var" varStatus="vs" >
														<li class="content-img-list-item"><img src="${var}" alt="" style="height: 100px"><a class="delete-btn" onclick="wgsc(this)"><i class="ico-delete"></i></a></li>
													</c:forEach>
												</c:if>
											</ul>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
			 ...
			 $.ajax({
				...
				success:function(data) {
					...
					$.each(data, function(index, item) {
						var option = $("<option value="+item+" ></option>").append(item);
						$('#YL19').append(option);
					});
				},
				error: function(e) {
		...
		function save(){
	    	...
	    	var RECEPTION_ID = $("#RECEPTION_ID").val();
		   	$.ajax({
				url: "<%=basePath%>reception/edit.do",
				data: {
