		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="luyin/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="LUYIN_ID" id="LUYIN_ID" value="${pd.LUYIN_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">创建人姓名:</td>
								<td><input type="text" name="CREATER" id="CREATER" value="${pd.CREATER}" maxlength="255" placeholder="这里输入创建人姓名" title="创建人姓名" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">录音内容:</td>
								<td><input type="text" name="CONTENT" id="CONTENT" value="${pd.CONTENT}" maxlength="255" placeholder="这里输入录音内容" title="录音内容" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">反馈单id:</td>
								<td><input type="text" name="INFORELAYID" id="INFORELAYID" value="${pd.INFORELAYID}" maxlength="255" placeholder="这里输入反馈单id" title="反馈单id" style="width:98%;"/></td>
							</tr>
							<tr>
