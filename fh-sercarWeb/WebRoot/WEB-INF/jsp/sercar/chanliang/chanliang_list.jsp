...
<body class="no-skin">
									...
									<tr>
										...
										<td class="center">
											<div class="hidden-sm hidden-xs btn-group">
												<a class="btn btn-mini btn-success" style="margin-right:3px; height:30px;line-height:30px; margin-bottom:5px;" onclick="listDsmx('${var.YL7}','${pd.lastStart }','${pd.lastEnd }');">派工明细</a>
											</div>
										</td>
									</tr>
								</c:forEach>
	...
	<script type="text/javascript">
		...
		function listDsmx(type,start,end){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="详情";
			 diag.URL = '<%=basePath%>chanliang/gochanlaing.do?YL7='+type+'&lastStart='+start+'&lastEnd='+end;
			 diag.Width = 800;
			 diag.Height = 740;
