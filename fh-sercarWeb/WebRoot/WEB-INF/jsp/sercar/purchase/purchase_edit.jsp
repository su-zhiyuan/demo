					...
					<form action="purchase/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="CHECKED_BY" id="CHECKED_BY" value="${pd.CHECKED_BY}" maxlength="50" placeholder="这里输入复核人" title="复核人" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">复核时间:</td>
								<td><input type="text" name="CHECKED_TIME" id="CHECKED_TIME" value="${pd.CHECKED_TIME}" maxlength="50" placeholder="这里输入复核时间" title="复核时间" style="width:98%;"/></td>
								<%-- <td style="padding-left:2px;"><input class="span10 date-picker" name="CHECKED_TIME" id="CHECKED_TIME"  value="${pd.CHECKED_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="复核时间" title="复核时间"/></td> --%>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">期望交付时间:</td>
								<td><input type="text" name="DELIVERY_TIME" id="DELIVERY_TIME" value="${pd.DELIVERY_TIME}" maxlength="50" placeholder="这里输入期望交付时间" title="期望交付时间" style="width:98%;"/></td>
								<%-- <td style="padding-left:2px;"><input class="span10 date-picker" name="DELIVERY_TIME" id="DELIVERY_TIME"  value="${pd.DELIVERY_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="期望交付时间" title="期望交付时间"/></td> --%>
							</tr>
							<tr>
