...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="statistics/partoffer.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastEnd" id="lastEnd"  value="${endTime }" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="创建时间止" title="创建时间止"/></td>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<tr>
								...
								<td class="center"> 总共报价单数： ${count }</td>
							</tr>
							<tr>
								<td class="center"> 指定时间段报价金额： ${total }</td>
								<td class="center"> </td>
								<td class="center"> 指定时间段报价定金： ${dingjin }</td>
							</tr>
						</table>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">报价单数</th>
									<th class="center">报价金额</th>
									<th class="center">报价定金金额</th>
								...
								<c:when test="${not empty varList2}">
									<c:forEach items="${varList2}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.DINGJIN }</td>
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-mini btn-success" style="margin-right:3px; height:30px;line-height:30px; margin-bottom:5px;" onclick="getDetails('${var.CREATE_BY}');">报价详情</a>
												</div>
											</td>
										</tr>
	...
	<script type="text/javascript">
		...
		function getDetails(name){
			...
			diag.Drag=true;
			diag.Title ="报价明细";
			diag.URL = '<%=basePath%>statistics/partdetails.do?CREATE_NAME='+name+'&lastStart='+startTime+'&lastEnd='+endTime;
			diag.Width = 800;
			diag.Height = 700;
