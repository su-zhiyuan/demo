						...
						<div id="zhongxin" style="padding-top: 13px;">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<c:if test="${not empty varList }">
									<c:forEach items="${varList }" var="dis">
										<tr>
											<tr>
												<td style="width:75px;text-align: right;padding-top: 13px;">技师姓名:</td>
												<td><input type="text" name="YL2" id="YL2" value="${dis.YL2}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
											</tr>
											<tr>
												<td style="width:75px;text-align: right;padding-top: 13px;">派工类型:</td>
												<td><input type="text" name="YL7" id="YL7" value="${dis.YL7}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
											</tr>
											<tr>
												<td style="width:75px;text-align: right;padding-top: 13px;">派工金额:</td>
												<td><input type="text" name="CREATE_TIME" id="CREATE_TIME" value="${dis.PRICE}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
											</tr>
											<tr>
												<td style="width:75px;text-align: right;padding-top: 13px;">派工单数目:</td>
												<td><input type="text" name="NUM" id="NUM" value="${dis.NUM}" maxlength="50" style="width:98%;" readonly="readonly"/></td>
											</tr>
											<tr>
												<td colspan="2">派工详情(工作项目数量：${dis.DSMXNUM })</td>
											</tr>
											<c:if test="${not empty dis.dsmxList }">
												<c:forEach items="${dis.dsmxList }" var="dsmx">
													<tr>
