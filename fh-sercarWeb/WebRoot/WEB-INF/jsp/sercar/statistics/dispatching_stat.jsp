...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="statistics/dispatching.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<tr>
								...
								<td class="center"> 总共派工单数： ${count }</td>
								<td class="center"> 派工总金额： ${total }</td>
							</tr>
						</table>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">维修单数</th>
									<th class="center">维修金额</th>
										...
										<tr>
											...
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-mini btn-success" style="margin-right:3px; height:30px;line-height:30px; margin-bottom:5px;" onclick="getDetails('${var.YL7}');">员工派工详情</a>
												</div>
											</td>
										</tr>
	...
	<script type="text/javascript">
		...
		function getDetails(type){
			...
			diag.Drag=true;
			diag.Title ="派工明细";
			diag.URL = '<%=basePath%>statistics/dispatchdetails.do?YL7='+type+'&lastStart='+startTime+'&lastEnd='+endTime;
			diag.Width = 800;
			diag.Height = 700;
