					...
					<form action="carinfo/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="CONTACT" id="CONTACT" value="" maxlength="255" placeholder="这里输入联系人" title="联系人" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">联系电话:</td>
								<td><input type="text" name="CONTACT_TEL" id="CONTACT_TEL" value="" maxlength="255" placeholder="这里输入联系电话" title="联系电话" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">汽车ID:</td>
								<td><input type="text" name="CAR_ID" id="CAR_ID" value="${pd.CAR_ID}" maxlength="255" placeholder="这里输入汽车ID" title="汽车ID" style="width:98%;" readonly= "readonly" /></td>
							</tr>
							<tr>
